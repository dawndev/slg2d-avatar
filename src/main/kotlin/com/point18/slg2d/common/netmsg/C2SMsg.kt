...
class C2SMsg(val msgType: MsgType) : Serializable {
    ...
    constructor(msgType: MsgType, clientMsgNo: Int, rt: Int, msgBodyBin: ByteArray?) : this(msgType) {  //构造器  无MessageLite的
